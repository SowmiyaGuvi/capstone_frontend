...
const Login = () => {
  ...
  return (
    <section className="vh-100 d-flex justify-content-center align-items-center" style={{ backgroundImage: `url(https://t3.ftcdn.net/jpg/03/30/81/70/360_F_330817072_DJIe5dlLrZDLjI62ORM5xDcDjixTUQrY.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
