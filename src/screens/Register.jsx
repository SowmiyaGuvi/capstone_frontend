...
const Signup = () => {
  ...
  return (
    <section className="vh-100" style={{ backgroundImage: `url(https://t3.ftcdn.net/jpg/03/30/81/70/360_F_330817072_DJIe5dlLrZDLjI62ORM5xDcDjixTUQrY.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <ToastContainer />
              ...
              <div className="card-body p-md-5">
                <div className="row justify-content-center">
                  ...
                  <div className="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                    <img src="https://t3.ftcdn.net/jpg/02/92/90/56/360_F_292905667_yFUJNJPngYeRNlrRL4hApHWxuYyRY4kN.jpg"
